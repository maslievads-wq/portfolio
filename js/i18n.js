...
const I18N = {
  ...
  ru: {
    ...
    cases: [
      ...
      { tag: 'Команда · Процессы · KPI', title: 'Маркетинговая команда с нуля: 12+ человек и системные процессы', summary: 'Выстроил маркетинговую команду с нуля и настроил процессы и KPI по каждому направлению — с фокусом на качество сервиса и удержание клиентов.', highlights: ['12+ человек в команде', 'NPS клиентов 90', 'LTV контракта 2+ года'], bullets: ['Нанял и собрал команду 12+ человек: SEO, performance, контент, SMM', 'Настроил процессы и прозрачные KPI по каждому направлению', 'Выстроил культуру клиентского сервиса — NPS клиентов 90 и средний LTV контракта 2+ года'] },
      { tag: 'Сквозная аналитика', title: 'Система сквозной аналитики: контроль каждого рекламного рубля', summary: 'Построил систему сквозной аналитики с контролем эффективности каждого канала, регулярной отчётностью и постоянным поиском точек роста.', highlights: ['Все каналы под контролем', 'Регулярная отчётность', 'Поиск точек роста'], bullets: ['Внедрил контроль эффективности по каждому рекламному каналу', 'Настроил регулярную отчётность по ключевым показателям', 'Системно искал точки роста и новые источники трафика'] },
