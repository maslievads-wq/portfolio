...
const I18N = {
  ...
  ru: {
    ...
    cases: [
      { tag: 'Go-To-Market · Performance · SEO', title: 'Забрали 60% рынка авторизованных сервисных центров Apple за 1 год при бюджете $3 500', summary: 'Вывел агентство For Hour в нишу маркетинга для авторизованных сервисных центров Apple: за 12 месяцев клиентами стали 60% рынка СНГ при маркетинговом бюджете $3 500.', highlights: ['60% рынка за 12 мес', 'Бюджет $3 500', 'LTV 3+ года', '№1 в СНГ'], blocks: [
        { h: 'Контекст проекта' },
        { p: 'Рекламное агентство For Hour выходило на новый рынок — авторизованные сервисные центры Apple. На момент старта ниша практически не имела специализированных подрядчиков, способных работать в соответствии с корпоративными требованиями Apple и учитывать специфику бизнеса АСЦ.' },
